...
# 725 "c:\\mingw\\include\\stdio.h" 3
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int getc (FILE *);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int putc (int, FILE *);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int getchar (void);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int putchar (int);
...
# 4 "openmp.c" 2
# 1 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\omp.h" 1 3 4
# 35 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\omp.h" 3 4
typedef struct
{
  unsigned char _x[4]
...
# 81 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\omp.h" 3 4
